...
function check(){
    var aaa=p();
    //var aaaa=p1();
    document.getElementById("still2").innerHTML=aaa
    }
...
function ready() {
    var removeCartItemButtons = document.getElementsByClassName('btn-danger-1')
    ...
    var addToCartButtons = document.getElementsByClassName('shop-item-button-1')
